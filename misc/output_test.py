...
""",
        ...
        self.assertEqual(
            run(print_red, flags="-v"),
            """[1/1] printf '\x1b[31mred\x1b[0m'
\x1b[31mred\x1b[0m
""",
        )
        self.assertEqual(
            run(print_red, flags="-v", pipe=True),
            """[1/1] printf '\x1b[31mred\x1b[0m'
red
""",
        )
        ...
        self.assertEqual(
            run(print_red, pipe=True, env=env),
            """[1/1] echo a
\x1b[31mred\x1b[0m
""",
        )
...
""",
    ...
    def test_ninja_status_default(self) -> None:
        ...
        self.assertEqual(
            run(Output.BUILD_SIMPLE_ECHO), "[1/1] echo a\x1b[K\ndo thing\n"
        )
...
""",
        ...
        self.assertEqual(
            run(plan, flags="-t inputs --dependency-order out3"),
            """in2
in1
out1
out2
...
""",
        ...
        self.assertEqual(
            run(plan, flags="-t inputs --no-shell-escape all"),
            """in1
out 2
out1
""",
        ...
        self.assertEqual(
            run(plan, flags="-t inputs --dependency-order all"),
            f"""in1
out1
{quote}out 2{quote}
""",
        ...
        self.assertEqual(
            run(plan, flags="-t inputs --dependency-order --no-shell-escape all"),
            f"""in1
out1
out 2
""",
