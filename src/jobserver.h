...
struct Jobserver {
  ...
  struct Config {
    ...
    ///
    /// kModeFileDescriptors means that `--jobserver-auth=R,W` is used to
    ...
    /// For kModeFileDescriptors, these are the file descriptor values
...
#else   // !_WIN32
    static constexpr Config::Mode kDefaultMode = Config::kModeFileDescriptors;
#endif  // !_WIN32
