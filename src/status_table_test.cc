...
TEST(StatusTable, NoCommands) {
  ...
  table.CommandStarted(cmd1, 0);
  table.CommandStarted(cmd2, 0);
  table.CommandStarted(cmd3, 0);
  table.UpdateTable(0);
...
TEST(StatusTable, TwoCommandsNoPeriodicUpdates) {
  ...
  table.CommandStarted(cmd1, 0);
  table.CommandStarted(cmd2, 250);
  table.CommandStarted(cmd3, 570);
...
TEST(StatusTable, ProperCommandDurations) {
  ...
  table.BuildStarted();
  table.CommandStarted(cmd1, 10000);
  table.CommandStarted(cmd2, 10250);
  table.CommandStarted(cmd3, 10570);
